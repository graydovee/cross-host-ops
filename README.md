...
Pushing a `v*` tag automatically publishes multi-platform binaries (Linux musl, macOS, Windows), a GHCR Docker image (`ghcr.io/graydovee/cross-host-ops:<tag>`), and the release checklist lives in [.agents/skills/xho-release/SKILL.md](.agents/skills/xho-release/SKILL.md).
